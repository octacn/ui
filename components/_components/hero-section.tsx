...
export default function HeroSection() {
  return (
    <BoxWrapper>
      ...
      <div className="mx-auto flex flex-col items-center gap-y-4 mt-10">
        <ChangelogBadge />
...
function ChangelogBadge() {
  return (
    <HoverAnimation href={"/changelog"}>
      <Badge
        variant={"outline"}
        className="mt-6 mb-2 rounded-full border hover:border-muted-foreground/20 hover:bg-muted-foreground/10 text-muted-foreground px-3 py-1.5 hover:text-foreground/80 font-inter text-xs font-normal tracking-wider gap-1.5 [&>svg]:size-3.5"
      >
